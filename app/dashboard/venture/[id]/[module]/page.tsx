...
import { resolveLandingComponent, stripGeneratedCodeFences, LANDING_RUNTIME_SHIM } from '@/lib/landing-page'
...
export default function ModulePage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: 'var(--bg)', position: 'relative' }}>
                          ...
                          <>
                            <motion.button
                              ...
                              style={{
                                ...
                                padding: '4px 9px',
                                borderRadius: 7,
                                border: `1px solid ${assetsOpen ? mod.accent : 'var(--border)'}`,
                                background: assetsOpen ? `${mod.accent}12` : 'transparent',
                                color: assetsOpen ? mod.accent : 'var(--text-soft)',
                                fontSize: 10,
                                fontWeight: 700,
                                letterSpacing: '0.04em',
                                cursor: 'pointer',
                              ...
                              title="Upload images for the landing page"
                            >
                            ...
                            <span style={{ width: 1, height: 14, background: 'var(--border)', opacity: 0.6, margin: '0 2px' }} />
                            <AnimatePresence>
                              {assetsOpen && (
                                <motion.div
                                  initial={{ opacity: 0, y: 8 }}
      ...
      {/* Click-away for landing-assets popover (zIndex below the popover's
          own zIndex: 30 so the popover stays clickable on top). */}
      {assetsOpen && (
        <div
