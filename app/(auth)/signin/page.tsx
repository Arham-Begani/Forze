...
const blob1Style: React.CSSProperties = {
  ...
  height: 560,
  borderRadius: "50%",
  background: "radial-gradient(circle, rgba(192,122,58,0.22) 0%, rgba(192,122,58,0.110) 35%, rgba(192,122,58,0.037) 62%, transparent 82%)",
...
const blob2Style: React.CSSProperties = {
  ...
  height: 480,
  borderRadius: "50%",
  background: "radial-gradient(circle, rgba(90,110,140,0.18) 0%, rgba(90,110,140,0.090) 35%, rgba(90,110,140,0.031) 62%, transparent 82%)",
  willChange: "transform",
  bottom: -160,
  left: -120,
  pointerEvents: "none",
...
const blob3Style: React.CSSProperties = {
  ...
  height: 300,
  borderRadius: "50%",
  background: "radial-gradient(circle, rgba(122,90,140,0.12) 0%, rgba(122,90,140,0.060) 35%, rgba(122,90,140,0.020) 62%, transparent 82%)",
  willChange: "transform",
  top: "40%",
  left: "10%",
  pointerEvents: "none",
