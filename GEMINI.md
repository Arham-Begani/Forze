...
- Never use localStorage or sessionStorage — use the project database
...
|--------|-------|-----------------|
| Full Launch Architect | gemini-3-pro-preview | Agent Teams + extended thinking |
| Research | gemini-3-flash | web_search tool enabled |
| Branding | gemini-3-flash | Structured JSON + Zod validation |
| Marketing | gemini-3-flash | Brand context injection |
| Landing Page | gemini-3-flash | Code generation + deploy hooks |
| Feasibility | gemini-3-flash | Extended thinking |
| Cleanup/formatting | gemini-3-flash | Mechanical tasks only |
...
| .agents/skills/* | Only when updating agent skill instructions |
